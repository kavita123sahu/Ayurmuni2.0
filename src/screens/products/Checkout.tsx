...
//             selectedProducts.every((item: any) => resolvePayOnDelivery(item)),
//         [selectedProducts],
//     );

//     const [selectedMethod, setSelectedMethod] = useState<PaymentMethod>(
//         codAvailable ? 'cod' : 'online',
//     );
...
//             if (!codAvailable) {
//                 showSuccessToast('Cash on delivery is not available for these items', 'error');
//                 return;
//             }
//             handleCOD();
