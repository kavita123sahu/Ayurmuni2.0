...
const ProductSearchScreen = (props: any) => {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <View style={[styles.headerWrap, { paddingHorizontal: hPad }]}>
        <Header
          title="Search"
          backIcon={Images.backIcon}
          onBack={() => safeGoBack(props.navigation)}
          subtitle="Products, brands, doctors, yoga & diets"
        ...
        isSearching ? (
          <View style={styles.loaderWrap}>
            ...
            <Text style={styles.loaderText}>
              {isRecentMode || recentLoadingHit
                ? 'Loading recent search…'
                : 'Searching across Ayurmuni…'}
            </Text>
          </View>
        ) : (
          <ProductGridSkeleton
