    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.topSection}>
                <Image source={Images.networkissue} resizeMode='cover' style={{ height: 150, tintColor: Colors.primaryColor, width: 150 }} />
            </View>
...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 22, fontFamily: Fonts.PoppinsMedium, color: Colors.textColor, marginBottom: 16, textAlign: 'center' },
    description: { fontSize: 14, color: Colors.textColor, textAlign: 'center', lineHeight: 18, marginBottom: 40, maxWidth: 400 },
    ...
    buttonText: { fontSize: 14, fontFamily: Fonts.PoppinsSemiBold, color: Colors.primaryColor }
});
