...
const styles = StyleSheet.create({
  ...
  messageText: { fontSize: 15, lineHeight: 20, color: '#1F2937', includeFontPadding: false },
  timestampContainer: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end',
    marginTop: 4, gap: 4,
  },
  timestamp: { fontSize: 10, color: '#6B7280', includeFontPadding: false },
  seenTick: { color: THEME },
  ...
  attachmentFileText: { fontSize: 13, color: THEME },
});